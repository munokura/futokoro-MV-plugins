...
//=============================================================================
/*:
@plugindesc v1.3.0 Plugin that adds original parameters
@author Futokoro
...
Overview
-----------------------------------------------------------------------------
Adds original parameters that can be used in damage calculation formulas.
...
v1.3.0 - 2020/03/21: Added Traits, removed in-plugin manual.
1. Added the ability to increase parameters when using items or skills.

v1.2.1 - 2018/10/16: Added Traits.
1. Added an error message when inputting incorrect original parameters. (F12)

v1.2.0 - 2018/09/29: Added Traits.
1. Added the ability to set display names for each code.

v1.1.6 - November 5, 2017: Bug Fixes
1. Fixed an issue where the effect of reducing current values set on items, etc., would not occur.

v1.1.5 - November 5, 2017: Bug Fixes and Traits Additions
1. Fixed an issue where parameter increases and decreases caused by leveling up or plugin commands would not be recorded in save data.
2. Added a Traits to plugin commands that allows you to specify party order.

v1.1.4 - April 30, 2017: Bug Fixes
1. Fixed an issue where items that restore current values could be used even when they were at their maximum value.

v1.1.3 - April 25, 2017: Bug Fixes
1. Fixed an issue where parameter changes set in states would not be Reflectioned.

v1.1.2 - April 14, 2017: Traits Additions
1. Added plugin commands.

v1.1.1 - 2017/03/23: Bug Fixes
1. Fixed an issue where codes from <Parameter 6> onwards could not be used.

v1.1.0 - 2017/03/17: Traits Additions, Specification Changes
1. Added the ability to set current and maximum values, like HP and MP.
2. Removed the ability to display parameters on the status screen.
3. Added the ability to write parameter codes in note tags.
4. Added the ability to create up to 10 original parameters.

v1.0.1 - 2017/02/18: Plugin Parameters Added, Bug Fixes
1. Added the ability to change the maximum parameter value using plugin parameters.
2. Revised the definition of defineProperties and fixed an issue where using parameter codes in calculation formulas would conflict with plugins that modify other calculation formulas.

v1.0.0 - February 16, 2017: Initial release

-----------------------------------------------------------------------------

@param Use Param Num
@desc How many original parameters to use? You can set up to 10.
@default 4

@param Max Level
@desc Setting the maximum actor level at which parameters increase
@default 99

@param Max Param
@desc Setting the maximum value of a parameter
@default 999

@param ---Parameter 0---

@param Parameter 0 Text
@desc Set the display name of the code

@param Parameter 0 Code
@desc Set the code name to be used in calculation formulas, etc.
@default str

@param Parameter 0 Current
@desc Set the code name to be used in calculations, etc. (current value) If left blank, the current value cannot be used.

@param Parameter 0 Max
@desc Setting the maximum value of a parameter

@param Parameter 0 Min
@desc Setting the minimum value of a parameter
...
@param Use Param Num
@desc 何個のオリジナルパラメータを使用するか 最大10個まで設定できます
@default 4
...
@param Parameter 0 Current
@desc 計算式等で使用するコード名を設定(現在値) 空欄の場合は、現在値を使用できません。
