...
/*~struct~xparam:
@param hit
@desc Accuracy display name
@default 命中率

@param eva
@desc Display name of evasion rate
@default 回避率

@param cri
@desc Criticality display name
@default 会心率

@param cev
@desc Display name of critical hit avoidance rate
@default 会心回避率
...
@param mrf
@desc Magic Reflectionion Display Name
@default 魔法反射率
...
@param hrg
@desc HP Regeneration Display Name
@default HP再生率

@param mrg
@desc MP playback rate display name
@default MP再生率

@param trg
@desc TP Regeneration Display Name
@default TP再生率
*/

/*~struct~sparam:
@param tgr
@desc Target rate display name
@default 狙われ率

@param grd
@desc Display name of defense effectiveness rate
@default 防御効果率

@param rec
@desc Display name of recovery effect rate
@default 回復効果率

@param pha
@desc Drug Knowledge Display Name
@default 薬の知識
...
@param mdr
@desc Magic Damage Display Name
@default 魔法ダメージ率

@param fdr
@desc Floor Damage Display Name
@default 床ダメージ率
