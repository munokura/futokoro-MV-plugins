...
FTKR.STP = FTKR.STP || {};
/*:
@plugindesc v1.1.0 A plugin to set Troops formation in the game
@author Futokoro
...
Overview
-----------------------------------------------------------------------------
By implementing this plugin, you can set Troops formation in the game.
...
-----------------------------------------------------------------------------
How to Set Troops Formation
-----------------------------------------------------------------------------
Use the following plugin command.
Note that you can specify the in-game variable IDx using '\V[x]' for values such as Troops ID, enemy ID, and coordinates.

1. Member Initialization

STP_TroopMembers_Reset id

Use id to set the Troops ID to be initialized (to empty its members).
Execute this before adding members.
...
STP_AddEnemyGroupMember id enemyID x y hidden

Set the Troops ID to which you want to add a member using id.
Set the hidden flag to true if you want the member to appear midway through the game, or false if they are present from the beginning.
...
v1.1.0 - 2017/05/25: Added Traits
1. Added the ability to add Troops members even during battle.

v1.0.0 - 2017/05/19: First version created
