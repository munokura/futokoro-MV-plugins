...
//=============================================================================
/*:
@plugindesc v1.7.1 Create your own scenes and windows
@author Futokoro
...
Overview
-----------------------------------------------------------------------------
Create original scenes and windows.

1. Easily create original scenes.
2. Create windows for original scenes, map scenes, and battle scenes.

You can create three types of windows:
1. Command Window - Displays commands for scene changes and common events.
2. Common Window - Displays various text, numbers, images, etc. (*1)
3. Select Window - Displays various text, numbers, images, etc. as a list. (*1)

(*1) If you want to display something other than text in the common window,
...
v1.7.1 - 2020/03/21: Bug Fixes
1. Fixed a bug that prevented the active window command from working properly. 2. Added the ability to set the window height and width independently.
3. Added the ability to set the command window height regardless of the number of commands.

v1.7.0 - 2019/12/16: Traits Added
1. Added the ability to set the display content for common windows using the statusList method of FTKR_CustomSimpleActorStatus.js.

v1.6.0 - 2018/10/08: Traits Added, Help Reduced
1. Added a plugin command to set the window skin.

v1.5.7 - 2018/09/17: Bug Fixes
1. Fixed a bug where changes to the command content of a created window would not be Reflectioned after "Update."

v1.5.6 - 2018/07/31: Bug Fixes
1. Fixed a bug where the actor's game data would not be Reflectioned correctly when an actor was added to the list in the Select Window.
2. Fixed an issue where selection information in the Command or Select window could not be correctly obtained.

v1.5.5 - 2018/06/18: Bug fixes
1. Fixed an issue where the Enable Escape Code plugin parameter setting was not Reflectioned.

v1.5.4 - 2018/05/24: Functionality fixes
1. Fixed the ability to use the text display command even when combined with FTKR_CustomSimpleActorStatus.js.

v1.5.3 - 2018/05/20: Help fixes
1. Added a script to obtain data for selected items in the Select window list.

v1.5.2 - 2018/03/12: Bug fixes
1. Fixed an issue where the display transparency of actor images changed.

v1.5.1 - 2018/02/15: Traits Added
1. Added a command to return the cursor to its initial position in the Command Window and Select Window.

v1.5.0 - 2018/02/14: Traits Added, Specification Changes, Help Corrections
1. Added the ability to turn window display on/off with an in-game switch.
2. Removed the ability to set the number of windows generated in the plugin parameters.
3. Changed so that the generation command must be executed to create windows, even in battle scenes.

v1.4.0 - 2018/01/16: Traits Added
1. Added a command to set the behavior when the command window is canceled.
2. Added a plugin command to exit the original scene.

v1.3.0 - July 9, 2017: Traits Added

v1.2.1 - June 23, 2017: Bug Fixes
1. Fixed a bug where control characters were not properly Reflectioned in the status settings when using display content settings.
2. Fixed an issue where the active status would not be turned off when the window display was turned off.
3. Added support for @type as a plugin parameter.

v1.2.0 - June 20, 2017: Traits Added
1. Added display content for the Select Window list settings.
2. Added a reference command that allows common windows to receive actors and data from the Select Window.

v1.1.1 - June 19, 2017: Help Fixes

v1.1.0 - June 19, 2017: Traits Added, Specification Changes
1. Removed the default setting for the "Close" command in original scenes.
2. Changed so that turning off the command window also turns off the active window.
3. Added the ability to close a scene and activate another window to the command addition method.
4. Modified so that common events can be called from an original scene.
5. Added the ability to create a select window.

v1.0.0 - June 17, 2017: First version created
...
@param Window Frame
@desc Whether to display the window frame: 1 - Display, 0 - Hide
@default 1
@type select
@option Show
@value 1
...
@desc Allows control characters to be used in commands. 1 - Enable, 0 - Disable
@default 0
@type select
@option valid
@value 1
...
@param Window Frame
@desc ウィンドウ枠を表示にするか 1 - 表示する, 0 - 表示しない
@default 1
@type select
@option 表示する
@value 1
...
@param Enable Escape Code
@desc コマンドに制御文字を使えるようにします。 1 - 有効, 0 - 無効
@default 0
@type select
@option 有効
@value 1
...
@param Command Align
@desc コマンドウィンドウのコマンド表示位置を設定します。 left / center / right
@default left
@type select
@option 左寄せ
@value left
...
@param --コモンウィンドウの表示内容設定--
@text --コモンウィンドウの表示内容設定--

@param Actor Status Space
@desc 各Textの間隔を指定します。 FTKR_CustomSimpleActorStatus.js が必要
@default 0,0,0,0

@param Actor Status Space In Text
@desc Text内で複数表示する場合の間隔を指定します。 FTKR_CustomSimpleActorStatus.js が必要
@default 5
@type number

@param Actor Status Width Rate
@desc Text1~Text3の表示幅の比率を指定します。 FTKR_CustomSimpleActorStatus.js が必要
@default 1,0,0
