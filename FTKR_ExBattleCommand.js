...
/*~struct~party:
@param fight
@desc Set the "Fight" command.
@type struct<command>

@param escape
@desc Set the "escape" command.
@type struct<command>

@param customs
@desc Set the party command to be added.
@type struct<custom>[]
*/

/*~struct~command:
@param enabled
@desc Command execution conditions Please match the command specifications.

@param ext
@desc Command extended parameters Please match the command specifications.

@param skillId
@desc Command skill ID 0 is no skill specified
@type number
@min 0
*/
...
/*~struct~custom:
@param name
@desc Command display name Please match the command specifications.

@param symbol
@desc Command symbols Please match the command specifications.
...
@param skillId
@desc Command explanation skill ID 0 is no skill specified
@type number
@min 0

@param show
@desc Command display conditions Please match the command specifications.
*/
...
/*~struct~command:ja
@param enabled
@desc コマンドの実行条件 コマンドの仕様に合わせてください。

@param ext
@desc コマンドの拡張パラメータ コマンドの仕様に合わせてください。

@param skillId
@desc コマンドのスキルID 0 は スキル未指定
@type number
@min 0
*/
...
/*~struct~custom:ja
@param name
@desc コマンドの表示名 コマンドの仕様に合わせてください。

@param symbol
@desc コマンドのシンボル コマンドの仕様に合わせてください。
...
@param skillId
@desc コマンドの説明用スキルID 0 は スキル未指定
@type number
@min 0

@param show
@desc コマンドの表示条件 コマンドの仕様に合わせてください。
*/
