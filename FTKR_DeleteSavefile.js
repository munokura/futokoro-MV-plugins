...
/*~struct~window:
@param windowskin
@desc Specify the image to use for the window skin. If left blank, the default image will be used.
@default Window
@type file
@require 1
@dir img/system/
...
@param opacity
@desc Specify the transparency of the background in the window from 0 to 255. 0 is transparent.
@default 192
@type number
@min 0
@max 255
...
@param frame
@desc Specifies whether to display the window frame.
@default true
@type boolean
@on Show
@off Do not display
...
@param Conf Title Format
@desc セーブファイルを削除する時の確認内容を記述します。 %1 - ファイル, %2 - ファイルID (制御文字を使用できます)
@default %1%2 を削除しますか？
