...
//=============================================================================
/*:
@plugindesc v1.3.0 Trump Card Game
@author Futokoro
...
Overview
-----------------------------------------------------------------------------
You can play the following card games.

1. Old Maid (2-4 players)
Set the plugin parameter <Number Of Jokers> to "1".
Set the plugin parameter <Number Of Removed Cards> to "0".

2. Old Man (2-4 players)
Set the plugin parameter <Number Of Jokers> to "0".
Set the plugin parameter <Number Of Removed Cards> to "1".
Or
Set the plugin parameter <Removed Card ID> and assign the removed card
information to the specified game variable.
In "Control Variables" - "Script",
enter the suit string (spade, heart, club, diamond) + rank number (1-13),
like this: "spade1"
...
2. Prepare card images and set them in the plugin parameters.
Save the card images in the img/pictures folder.

<Card Image Format>
1. Face Cards and Number Cards
Prepare individual images, such as ***01.png.
The *** should be the same for each suit.
The number portion of 01 should represent the card's rank (number) in two digits.

2. Joker and Back Cards
Feel free to name them as you like.

<How to Set Plugin Parameters>
1. Face Cards and Number Cards
Set the filenames of the prepared images for each suit in the following format:
***%1
- *** is the string portion of the image file.

2. Joker and Back Cards
You can select images from the img/pictures folder.

3. Deployment Support
If you enable "Exclude unused files" in deployment,
Please use the following file names for face and number cards.

Spades: s01.png ~ s13.png
Clubs: c01.png ~ c13.png
Hearts: h01.png ~ h13.png
Diamonds: d01.png ~ d13.png
...
First, specify the in-game variable using the plugin parameter <Player * ID>.

CRD_SETTING_PLAYER [player1] [player2] ...

Set the players participating in the game.
Set the actor ID (up to 4).
Setting -1 will make the character the party leader.
Player 1 will be the controlled character.

2. Game Count Settings

Set the number of games to be played in one set.
Change the value of the game variable specified by the plugin parameter <Game Count ID>.

3. Game Point Settings
Set the points earned in one game, in order of win.
The points earned by each player are saved in the in-game variable specified by the plugin parameter.
Points are accumulated as the game progresses.

Set with Plugin Parameters
<Ranking Points>
...
Displays the game screen and starts the game.
After playing the set number of games, the game will return to the original screen.


-----------------------------------------------------------------------------
Player Controls
-----------------------------------------------------------------------------
Player 1 participates in the game as the controlled character.

When drawing a card from your opponent, you can place it anywhere by moving the cursor to any location.

You can also place the drawn card anywhere in your hand.

Due to the characteristics of NPCs, described below, the placement of cards in your hand is important, so consider where you place them as you play.

<About the Rearrange Command>
Once you've decided where to place the drawn card, you can choose to end your turn or rearrange it.

Selecting the Rearrange command will return the cursor to your hand, allowing you to rearrange your cards.

To do this, move the cursor to the card you want to rearrange and press the Confirm button.
Then, move the cursor to the desired location and press the Confirm button.

Selecting the same location at this time will cause the card to be protruding.

<NPC Turn>
NPC turns proceed automatically.


-----------------------------------------------------------------------------
Setting NPC Traits
-----------------------------------------------------------------------------
Actors other than Player 1 will participate in the game as NPCs.

You can set traits for each actor by adding the following tags to their memo field.

Setting traits and facial expressions
<CRD_特徴>
Content: Probability
</CRD_特徴>
...
Setting dialogue
<CRD_台詞>
Content: Probability, Dialogue
</CRD_台詞>

Probability is a value between 1 and 10, and you can set the probability of the content being executed in 10% increments.
For dialogue, enter the text to be displayed.
The following options are available:

<How to Take Cards>

1. Edge Pick - Choose a card from the two ends of your opponent's hand.
2. Don't Take an Edge Card - Don't choose a card from the two ends of your opponent's hand.

3. Center Pick - Choose a card in the center of your opponent's hand.
(If your hand has an even number of cards, choose from the two center cards.)
4. Don't Take an Center Card - Don't choose a card in the center of your opponent's hand.
(If your hand has an even number of cards, don't choose the two center cards.)

5. Right Pick - Choose a card to the right of the center of your opponent's hand.
6. Left Pick - Choose a card to the left of the center of your opponent's hand.

7. Take a Protruding Card - Choose a card that is protruding from your opponent's hand.
8. Don't Take a Protruding Card - Don't choose a card that is protruding from your opponent's hand.

<Information about arranging captured cards>

1. Edge - Place the card on either side of your hand.
2. Not Edge - Do not place the card on either side of your hand.

3. Center - Place the card in the center of your hand.
4. Not Center - Do not place the card in the center of your hand.

5. Right - Place the card to the right of the center of your hand.
6. Left - Place the card to the left of the center of your hand.

<Information about pushing out cards from your hand>

1. Push out a Joker - If you have a Joker in your hand, push it out.
2. Push out a non-Joker - Push out a card from your hand other than a Joker.

<Information about temporary facial expressions>
*This change will be canceled at the end of your turn.

1. Draw a Joker (x) - Change your face image to number x when you draw a Joker.
2. Draw a non-Joker (x) - Change your face image to number x when you draw a non-Joker.
3. Pair made (x) - Change your face image to number x when you make a pair.
4. Unable to pair (x) - Change your face image to number x when you do not make a pair.

<Information about constantly changing facial expressions>

1. Holding a Joker (x) - Change your face image to number x while you are holding a Joker.
2. Not holding a Joker (x) - Change your face image to number x while you are holding a Joker.


<Dialogue Details>
*This dialogue will be erased at the end of your turn.

1. Draw a Joker - Display the specified dialogue when you draw a Joker.
2. Draw a Non-Joker - Display the specified dialogue when you draw a non-Joker.
3. Pair Formed - Display the specified dialogue when a pair is formed.
4. Unable to Pair - Display the specified dialogue when a pair is not formed.

Multiple traits can be set.
If there are multiple traits, they will be processed in order from top to bottom.

Example)
<CRD_特徴>
Pick from the edge: 7
Pick from the right: 10
</CRD_特徴>
<CRD_台詞>
Pick a Joker: 7, It's the Joker!
</CRD_台詞>

In this case, the NPC's card-taking process is as follows:
First, a decision is made as to whether to take the opponent's edge card.
If the decision is successful, the number of cards to take will be narrowed down to two.
If the decision is unsuccessful, the number of cards to take will be all cards.

Then, the target is narrowed down to the right side of the target. (Process the second step)
If the "take from edge" decision is successful, there are only two cards to take,
and the card to the right of that, that is, the card on the right side of the opponent's hand, will ultimately be chosen.
If the decision is unsuccessful, a card will be chosen at random from the right side of the opponent's hand.

Furthermore, if you draw a Joker, there is a 70% chance that the NPC will speak a line.

-----------------------------------------------------------------------------
About Common Events During Card Games
-----------------------------------------------------------------------------
By setting a common event ID in the <Card Game Event> plugin parameter,
you can execute a common event during a card game.

You can set multiple common event IDs in the <Card Game Event> plugin parameter by using commas (,) and hyphens (-).
A hyphen (-) registers all IDs between the IDs it connects.

Example:
1, 4, 5, 10-15

If multiple event IDs are entered, the execution conditions are evaluated in the order they are entered (from left to right), and if the conditions are met, the event is executed.

-----------------------------------------------------------------------------
Setting Common Event Execution Conditions During Card Games
----------------------------------------------------------------------------
You can set execution conditions for common events by entering the following annotations.

<SPAN: [TIMING]>
Sets the execution count.
If no span is specified, this setting will be applied.
Enter one of the following for [TIMING]:
GAME - Executes only once during the game.
TURN - Executes only once during the turn.
MOMENT - Executes each time the condition is met.

<TURNEND>
Executes at the end of a turn.

<DRAWCARD>
Executes when a card is drawn.

<ACTOR: a>
Executes on the turn of actor ID a.

<TURN: a + b *X>
Executes on the specified turn.
Enter numbers for a and b. (* and X are half-width characters, X is entered as X.)
a - Number of turns to execute first
b - Number of turns to wait after the next execution (subsequent executions will occur every time this number of turns has passed).
Example:
<TURN: 1 + 2 *X>
<TURN: 2 + 4 *X>

<CARD_NUMBERS: #a LESS THAN b>
Executes based on the number of cards held by the specified player.
Enter numbers for a and b.
Be sure to include a space between a and b.
a - Player No. (1-4)
b - Number of remaining cards
Example)
<CARD_NUMBERS: #2 LESS THAN 7>

<SWITCH: a>
Executes when the specified switch is ON.
Enter a number for a.
a - Switch ID


-----------------------------------------------------------------------------
Scripts that can be used in common events
-----------------------------------------------------------------------------
The following scripts can be used in common events.

CardGameManager._turnCount
: Number of turns

CardGameManager.drawCard()
: Information about the drawn card
: CardGameManager.drawCard().suit - Card suit (mark)
: CardGameManager.drawCard().rank - Card rank

CardGameManager.isDrawJoker()
: Determines whether a Joker was drawn
...
v1.3.0 - 2020/01/10: Feature additions, bug fixes
1. Added the ability to remove cards other than Jokers at the start of a game.
*This enables the so-called "no Joker" game.
2. Fixed a bug that caused an error to occur if all cards in hand were initially paired.

v1.2.4 - 2018/08/13: Bug fixes
1. Fixed an issue where the game ended before any points were scored at the end of a two-player game.

v1.2.3 - 2018/08/12: Bug fixes
1. Fixed an issue where the player's final lines of dialogue would remain until the next game.
2. Added the ability to enable or disable the display of the background frame in the hand window.

v1.2.2 - August 12, 2018: Bug Fixes
1. Fixed an error that occurred when a player remained until the end and drew a card even though there were no other remaining NPCs.
2. Fixed an issue in the second game or later where pressing the Confirm button while cards were being dealt would end the card deal and the game would begin even if not all cards had been dealt.

v1.2.1 - October 2, 2017: Help Updates
1. Fixed a typographical error regarding NPC dialogue settings.

v1.2.0 - July 29, 2017: Feature Additions
1. Added the ability to execute common events during card games.

v1.1.1 - July 22, 2017: Feature Additions
1. Added the ability to add animation to cards when dealing and discarding pairs.
2. Added the ability to set sound effects when dealing cards.

v1.1.0 - 2017/07/19: Feature Additions
1. Added the ability to add animation to cards when drawing or adding them to your hand.
2. Changed NPC turns to automatically advance.
3. Added the ability to change the color of the character's status window during their turn.
4. Revised the layout for two-player and three-player modes.
5. Added the ability to set the in-game background music and sound effects when drawing cards.

v1.0.2 - 2017/07/11: Bug Fixes
1. Fixed an issue where the game would sometimes not progress when the card game screen was displayed.

v1.0.1 - 2017/07/09: Bug Fixes
1. Fixed an error that occurred when using the plugin command to set the player.

v1.0.0 - 2017/07/09: Official Release
1. Added the ability to set NPC dialogue.
2. Added the ability to turn NPC dialogue, expressions, and traits on/off with an in-game switch.
3. Changed the number of games to be set using an in-game variable.
4. Removed some plugin parameters.
5. Added the ability to set command names using plugin parameters.
6. Added the ability to randomly determine the starting player.
7. Revised NPC placement.
8. Added the ability to change the display color of the player's name during their turn.

v0.9.0 - 2017/07/06: Added Features
1. Added the ability to set cards in any location when drawn.
2. Added the ability to sort cards in your hand.
3. Added the ability to set NPC traits.

v0.8.0 - 2017/07/03: Added features, renamed plugin parameters.
1. Added support for "unused files" in deployment.
2. Added the ability to set the number of games.
3. Added a feature to obtain points in order of ranking and display them on the screen.
4. Added a feature to store ranking points in in-game variables.
5. Changed the names of some plugin parameters.
6. Changed ranking to display fourth place as well.

v0.7.5 - 2017/07/02: Added Features
1. Added player settings.
2. Added a feature to display player names and faces.
3. Changed the game to continue until there is only one player left.
4. Changed the setting so that unselected cards are transparent when selecting cards.

v0.7.0 - 2017/07/02: Prototype created

@param --カードの設定--
@text --Card Settings--

@param Suit Type
@desc Select the suit (mark) to use. Spade/Club/Heart/Diamond Separate with a comma (,)
@default spade,heart,club,diamond

@param Max Rank
@desc Select the maximum rank (number) to use: 1 to 13
@default 13
@type number
@min 1
@max 13
...
@desc Select the number of jokers to use: 0 to 2
@default 1
@type number
@min 0
@max 2
...
@desc Set the number of cards to be removed at the start of the game. *Jokers cannot be removed.
@default 0
@type number
...
@desc Sets the color of the player whose turn it is.
@default 18
@type number

@param Subject Window Tone
@desc Sets the window color for the player whose turn it is. Enter R,G,B separated by commas (,).
@default 255,255,0

@param Target Player Color
@desc Set the color of the opponent player who will draw their hand.
@default 29
@type number

@param Ranking Points
@desc Set the points to be acquired by the result of the game. Separate with a comma (,) and set from 1st to 4th place.
@default 2,1,-1,-2

@param Draw Speed
@desc Set the speed at which you draw your cards.
@default 30
@type number

@param Draw Height
@desc Set the height at which you draw your hand.
@default 60
@type number

@param Deal Speed
@desc Sets the speed at which the deck is dealt.
@default 5
@type number

@param First Discard Speed
@desc Sets how quickly cards are discarded from your starting hand.
@default 10
@type number
...
@param Game BGM Name
@desc Set the BGM for card games.
@type file
@require 1
@dir audio/bgm

@param Game BGM Pitch
@desc Sets the pitch of the BGM during card games.
@default 100
@type number
@min 50
@max 150
...
@desc Set the volume of the BGM during card games.
@default 90
@type number
@min 0
@max 100
...
@param Draw SE Name
@desc Set the sound effect when drawing a card.
@default Book1
@type file
@require 1
@dir audio/se
...
@param Draw SE Pitch
@desc Sets the pitch of the sound effect when drawing a card.
@default 100
@type number
@min 50
@max 150
...
@desc Sets the volume of the sound effect when drawing a card.
@default 90
@type number
@min 0
@max 100
...
@param Deal SE Name
@desc Sets the sound effect when dealing cards.
@default Wind4
@type file
@require 1
@dir audio/se
...
@param Deal SE Pitch
@desc Sets the pitch of the sound effect when dealing cards.
@default 100
@type number
@min 50
@max 150
...
@desc Sets the volume of the sound effect when dealing cards.
@default 30
@type number
@min 0
@max 100
...
@param --ゲーム変数の設定--
@text --Setting Game Variables--

@param Game Count ID
@desc Specify the ID of the variable to set the number of games.
@type variable

@param Draw Speed ID
@desc Specify the ID of the variable that sets the speed at which cards are drawn. If not set, it will be fixed at the Draw Speed setting.
@type variable

@param Removed Card ID
@desc Specifies the ID of the variable to directly set the card to be removed at the start of the game. If you want it to be set automatically, you do not need to specify this ID.
@type variable

@param Player 1 ID
@desc Stores Player 1's actor ID in the specified variable.
@type variable

@param Player 1 Result
@desc Stores the result of Player 1 in the specified variable.
@type variable

@param Player 2 ID
@desc Stores Player 2's actor ID in the specified variable.
@type variable

@param Player 2 Result
@desc Stores the result of Player 2 in the specified variable.
@type variable

@param Player 3 ID
@desc Stores Player 3's actor ID in the specified variable.
@type variable

@param Player 3 Result
@desc Stores the result of Player 3 in the specified variable.
@type variable

@param Player 4 ID
@desc Stores Player 4's actor ID in the specified variable.
@type variable

@param Player 4 Result
@desc Store the result of Player 4 in the specified variable.
@type variable

@param --ゲームスイッチの設定--
@text --Game Switch Settings--

@param Random Start ID
@desc Specifies the ID of the switch that enables or disables the function to randomize the starting player.
@type switch

@param NPC Dialogues ID
@desc Specifies the ID of the switch that enables or disables the NPC's dialogue.
@type switch

@param NPC Facial Expressions ID
@desc Specifies the ID of the switch that enables or disables the NPC's facial expressions.
@type switch

@param NPC Characteristics ID
@desc Specifies the ID of the switch that enables or disables the NPC's Traits.
@type switch

@param --勝敗結果の取得--
@text --Getting the win/loss results--

@param Reset Variables
@desc When the game screen is displayed, the specified variable is set to 0. 0 - Disabled, 1 - Enabled
@default 1
@type number
...
@param Hand Width
@desc Set the display width of your hand cards.
@default 408
@type number

@param Hand Height
@desc Set the display height of your hand cards.
@default 180
@type number

@param Hand Frame
@desc Set whether or not to display the background frame of your hand.
@default true
@type boolean
@on Show
@off Do not display
...
@desc Sets the width of the dialogue window.
@default 240
@type number

@param Dialogue Height
@desc Sets the height of the dialogue window.
@default 72
@type number

@param Dialogue Offset Y
@desc Sets the difference in Y coordinate between the dialogue window and the actor window.
@default 18
@type number

@param Dialogue Skin
@desc Sets the skin for the dialogue window. If not set, the default skin will be used.
@type file
@require 1
@dir img/system/
...
@desc Sets the command name to end the turn.
@default ターン終了

@param Sort Command
@desc Set the command name to sort your hand.
@default 並び替え
...
@param Spade Images
@desc Set the spade card image name.

@param Culb Images
@desc Set the club card image name.

@param Heart Images
@desc Set the heart card image name.

@param Diamond Images
@desc Set the diamond card image name.

@param Back Image
@desc Sets the image on the back of the card.
@type file
@require 1
@dir img/pictures/

@param Joker Image
@desc Set the image of the Joker.
@type file
@require 1
@dir img/pictures/

@param Background Image
@desc Sets the background image for the field.
@type file
@require 1
@dir img/pictures/
...
@desc Set the ID of the common event to be executed during the card game. 0 - Do not execute. Multiple IDs can be set by separating them with commas (,).
@default 0
...
@desc The game is played with all cards face up. 0 - Disable, 1 - Enable
@default 0
@type number
*/
...
@param Suit Type
@desc 使用するスート(マーク)を選択します。 spade/club/heart/diamond カンマ(,)で区切ること
@default spade,heart,club,diamond

@param Max Rank
@desc 使用する最大ランク(数字)を選択します。 1 ~ 13
@default 13
@type number
@min 1
@max 13
...
@param Number Of Removed Card
@desc ゲーム開始時に取り除くカード枚数を設定します。 ※ジョーカーは取り除くことはできません。
@default 0
@type number
...
@param Subject Window Tone
@desc 現在ターンのプレイヤーのウィンドウカラーを設定します。 R,G,B とカンマ(,)で区切って入力してください。
@default 255,255,0
...
@param Ranking Points
@desc ゲームの勝敗の結果で取得するポイントを設定します。 カンマ(,)で区切って、1位から4位まで設定してください。
@default 2,1,-1,-2
...
@param Draw Speed ID
@desc カードを引く早さを設定する変数のIDを指定します。 設定しない場合は、Draw Speedの設定で固定します。
@type variable
...
@param Reset Variables
@desc ゲーム画面表示時に、指定した変数に 0 を代入します。 0 - 無効、1 - 有効
@default 1
@type number
...
@param Dialogue Skin
@desc 台詞ウィンドウのスキンを設定します。 設定しない場合は、デフォルトスキンを使用します。
@type file
@require 1
@dir img/system/
...
@param Card Game Events
@desc カードゲーム中に実行するコモンイベントのIDを設定します。 0 - 実行しない、カンマ(,)で区切って複数設定できます
@default 0
...
@param Open Card Mode
@desc すべてのカードを表にした状態でゲームを行います。 0 - 無効にする, 1 - 有効にする
@default 0
@type number
*/
