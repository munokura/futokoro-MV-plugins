...
Overview
-----------------------------------------------------------------------------
Implementing this plugin adds the ability to display subcommands.

Subcommands have the following standard functions:
1. Execute a skill.
2. Delete (forget) a learned skill.
...
3. This plugin cannot be used in conjunction with FTKR_SEP_ShowSkillStatus.js.

-----------------------------------------------------------------------------
Skill Deletion Conditions
-----------------------------------------------------------------------------
By default, skills can be deleted unconditionally.
However, you can set deletion conditions by adding the following notetags to skills.
...
The condition expression (eval) allows you to use non-fixed values by entering a calculation formula, like a damage calculation formula.
...
Input Example)
Deletion is possible when switch ID 1 is ON.
<EIC FORGET>
s[1]
</EIC FORGET>
...
-----------------------------------------------------------------------------
You can set custom commands that execute common events.
Note that the menu will automatically close when a common event is executed.

Set this using the following plugin parameters.

<ustom1 Format>
: Set the command name to display in the subcommand.

<Custom1 EventID>
: Set the ID of the common event to execute.

You can obtain information about the actor and skill that executed the subcommand using the following script.
...
v1.0.0 - 2017/04/15: First version created
...
@desc Describes the display content of "Custom Command 1" in the execution command.
