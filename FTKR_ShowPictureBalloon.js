...
/*~struct~balloon:
@param iconImage
@desc Set the image file for the Balloon Icon to use. The image file must be saved in /img/system.
@default Balloon
@type file
@require 1
@dir img/system/
...
@param width
@desc Sets the width of the Balloon Icon.
@default 48
@type number

@param height
@desc Set the height of the Balloon Icon.
@default 48
@type number

@param speed
@desc Set the display time for one frame of the Balloon Icon.
@default 8
@type number

@param waitTime
@desc Set the wait time after the Balloon Icon is displayed.
@default 12
@type number
*/
...
/*~struct~balloon:ja
@param iconImage
@desc 使用するフキダシアイコン画像ファイルを設定します。 画像ファイルは/img/systemに保存すること
@default Balloon
@type file
@require 1
@dir img/system/
