...
//=============================================================================
/*:
@plugindesc v1.0.0 A plugin that creates a state that doubles the number of Repeat
@author Futokoro
...
Overview
-----------------------------------------------------------------------------
Adding the following tag to the state's Note field will double the number of consecutive states while the state is being added.

<CRS_連続回数倍加: x>
x - Multiplies the number of consecutive states by x.
...
v1.0.0 - 2017/08/23: First version created
