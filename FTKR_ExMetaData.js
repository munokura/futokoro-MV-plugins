...
//=============================================================================
/*:
@plugindesc v1.0.1 Metadata extension plugin
@author Futokoro
...
Overview
-----------------------------------------------------------------------------
This plugin imports the following metadata (*1) into each object data.

(*1) Data written in the <name:data> format

1. Metadata in the annotations on the first page of an Troops battle event
is imported into $dataTroops[n].meta when the game starts.
(n is the Troops ID)

2. Metadata in the annotations on the first page of an event
is imported into $dataMap.events[n].meta when map data is loaded.
(n is the event ID)
...
v1.0.1 - 2018/02/19: Bug fixes
1. Fixed an issue where metadata would disappear when opening and closing the menu.

v1.0.0 - 2017/05/05: First version created
