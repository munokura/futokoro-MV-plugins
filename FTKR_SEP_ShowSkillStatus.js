...
@param Apply SSS Layout
@desc スキルメニューのレイアウトをSSS仕様に変えるか。 0 - 変えない, 1 - Aタイプに変える, 2 - Bタイプに変える
@default 0

@param Show Disabled Item
@desc 無効になっているダメージや使用効果も表示するか。 1 - 表示する, 0 - 表示しない
@default 0

@param Draw SSS Cost
@desc スキルのコスト表示をSSS仕様に変えるか。 1 - 変える, 0 - 変えない
@default 0

@param Enabled Sub Command
@desc スキル選択後にサブコマンドを表示するか。 1 - 表示する, 0 - 表示しない
@default 0

@param Enable Confirmation
@desc スキルを忘れる時に確認画面で実行確認するか。 1 - 確認する, 0 - 確認しない
@default 1
...
@param Skill List Max Cols
@desc スキルリスト1行に表示するスキルの数を指定します。 (最小値 1)
@default 2

@param Skill List Spacing
@desc スキル複数列表示の場合のスキルの間隔を指定します。 (デフォルト 48)
@default 48

@param SSS HP Cost Format
@desc SSS仕様のコスト表示内容を文字列で記述します。 %1 - HPコスト
@default %1\c[21]\nHP\c[21]\sb[50]

@param SSS TP Cost Format
@desc SSS仕様のコスト表示内容を文字列で記述します。 %1 - TPコスト
@default %1\c[29]\nTP\c[29]\sb[50]

@param SSS MP Cost Format
@desc SSS仕様のMPコスト表示内容を文字列で記述します。 %1 - MPコスト
@default %1\c[23]\nMP\c[23]\sb[50]
...
@param Actor Status Width Rate
@desc Text1~Text3の表示幅の比率を指定します。 詳細はヘルプ参照
@default 1,1,0

@param Display Face Scale
@desc アクターの顔画像を表示スケールを設定します 標準は 4 で、それ以外の場合に画像を拡大縮小します
@default 3
...
@param Conf Title Format
@desc スキル削除実行時の確認内容を記述します。 %1 - アクター名, %2 - スキル名
@default [%2]を忘れますか？
...
@param Display Frame Type
@desc 表示するコマンド枠のタイプを設定します(0 - 非表示) 1 - 単線, 2 - 複線, 3 - 画像, 4 - 単線+画像, 5 - 複線+画像
@default 1

@param When To Display Frame
@desc コマンド枠を表示するタイミング 0 - 常時, 1 - カーソルと重なる時, 2 - カーソルと重ならない時
@default 1

@param Change Frame On Cursor
@desc カーソルと重なった時に枠を変更する機能 0 - 無効, 1 - 有効
@default 1

@param Hide Cursor
@desc コマンドカーソルを非表示にする機能 0 - 無効, 1 - 有効
@default 0
...
@param Enabled Change Scale
@desc 枠画像とカーソルサイズが異なる時の自動サイズ調整機能 0 - 無効, 1 - 有効
@default 1
